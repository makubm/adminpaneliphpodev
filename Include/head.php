    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger <?php if ($sayfa=="İstaston") echo "active" ?>" href="istasyon">İstaston</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger <?php if ($sayfa=="Paketler") echo "active" ?>" href="paketler">Paketler</a></li>
