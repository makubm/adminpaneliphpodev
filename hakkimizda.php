...
?>
        ...
        <div class="container">
            ...
            <ul class="timeline">
                ...
                while ($sonuc2 = $sorgu2->fetch()) {
                    ?>
                    <li <?php if ($yon == false) echo 'class="timeline-inverted"'; ?>>
                        <div class="timeline-image"><img class="rounded-circle img-fluid"
                                                         src="assets/img/about/<?= $sonuc2 ["foto"] ?>"
                                                         alt=""/></div>
    ...
    <section class="page-section bg-light" id="team">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center"><p class="large text-muted"><?= $sonuc ["altIcerik2"] ?></p>
                </div>
            </div>
        </div>
    </section>
